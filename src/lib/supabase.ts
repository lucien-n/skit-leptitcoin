...
export async function dislikeListing(listing_uid: string, user_uid: string): Promise<boolean> {
	try {
...
export async function likeListing(listing_uid: string, user_uid: string): Promise<boolean> {
	try {
